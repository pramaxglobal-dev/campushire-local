...
const navByRole: Record<UserRole, NavItem[]> = {
  ...
  SUPER_ADMIN: [
    ...
    { label: "Tenants", href: `${ROUTES.dashboard.admin}?section=tenants`, icon: Building2 },
    { label: "Jobs", href: ROUTES.jobs.list, icon: Briefcase },
    { label: "White Label", href: ROUTES.whitelabel, icon: Building2 },
    { label: "Platform Settings", href: `${ROUTES.dashboard.admin}?section=platform-settings`, icon: Settings },
